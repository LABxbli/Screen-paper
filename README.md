...
15. **`TSP2_tree_files`** - Contains the sequence alignment generated by MAFFT, the maximum-likelihood phylogenetic tree produced by IQ-TREE 2, and the formatted phylogenetic tree used in the manuscript for evolutionary analysis of TSP2 homologs.
